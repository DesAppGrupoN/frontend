...
export const getAllProductsByCommerceId = commerceId => { return axios.get(path + `get/by_commerce_id/${commerceId}`) }
export const searchProductsByCommerceId = commerceId => { return axios.get(path + `search/by_commerce_id/${commerceId}`) }
